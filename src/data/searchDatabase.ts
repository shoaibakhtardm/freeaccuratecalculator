// src/data/searchDatabase.ts
// Auto-generated searchable index of all verified calculators with icons, categories, and direct links
...
export const SEARCHABLE_CALCULATORS: SearchCalculatorItem[] = [
  ...
  {
    "name": "Bakers Percentage Calculator",
  ...
  {
    "name": "Calorie per Serving Calculator",
    "slug": "calorie-per-serving-calculator",
    "category": "food",
    "categoryName": "Food",
    "icon": "🍎",
  ...
  {
    "name": "Velocity & Acceleration Calculator",
