...
export const COUNTRIES: Record<string, CountryConfig> = {
  ...
  FR: {
    ...
    unitSystem: 'metric',
    isPopular: true,
    taxSystemName: 'Impôt sur le Revenu (Barème 2026 & TMI)',
    popularCalculators: [
      'simulateur-apl',
      'apl-simulator',
    ...
    tax2026: {
      taxYear: 'Année Fiscale 2026 (Revenus 2025/2026)',
      sourceAuthority: 'Direction Générale des Finances Publiques (DGFiP) & URSSAF',
      sourceUrl: 'https://www.impots.gouv.fr',
      lastVerifiedDate: '2026-09-16',
      standardDeductions: {
        forfaitaire_10pct_min: 495,
        forfaitaire_10pct_max: 14171,
      },
      limits: {
        ...
        passAnnuel: 47100,
        pmssMensuel: 3925,
        indemniteLicenciementExoMax: 94200,
        aplPlancherVersement: 15,
      },
      brackets: {
        tmi: [
      ...
      notes: 'Barème 2026 officiel : SMIC 11,88 €/h (1 801,80 € brut/mois), PASS 47 100 €, abattement 10% plafonné à 14 171 €, barème kilométrique DGFIP avec majoration de 20% pour véhicule électrique.',
    },
  },
